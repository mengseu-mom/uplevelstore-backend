  ...
  return (
    <div className="w-full flex  flex-col justify-center items-center mb-20">
      <div className=" w-full flex flex-col items-center justify-center space-y-14  bg-gradient-to-t from-green-200 via-green-200 to-white py-16 rounded-b-lg">
        <p className=" text-5xl font-bold text-[#009639]">Checkout</p>
      ...
      <div className=" flex w-9/12  mt-20 space-x-4">
        <div className=" w-3/5 space-y-9 px-10">
          <p className="text-[#009639] text-xl font-bold">Billing Detail</p>
          <div className=" flex space-x-10">
            <div className="w-full  space-y-2 flex flex-col">
              ...
              <input
                ...
                className="bg-gray-50 shadow-inner focus:outline-none rounded-md placeholder:text-sm pl-3 py-2"
              />
            </div>
            <div className="w-full  space-y-2 flex flex-col">
              <label htmlFor="" className="text-gray-600">
          ...
          <div className=" space-y-2">
            ...
            <select
              id="city"
              name="city"
              className="bg-gray-50 shadow-inner focus:outline-none rounded-md text-gray-600  text-sm pl-3 py-2"
            >
              <option value="">Select a city</option>
              <option value="newyork">Cambodia</option>
              <option value="losangeles">China</option>
        ...
        >
          ...
          <div className=" w-full flex items-center justify-center mt-10">
            <button className="bg-[#009639] text-white px-10 rounded-md py-3" onClick={() => navigate("/payment")}>
              Proceed to Payments
            </button>
          </div>
        </div>
